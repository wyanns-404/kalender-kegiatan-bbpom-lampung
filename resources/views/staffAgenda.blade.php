...
<head>
    ...
    <title>Staff | Kalender Kegiatan | Balai Besar POM di Bandar Lampung</title>

    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    
    @vite(['resources/css/app.css', 'resources/css/agenda.css', 'resources/js/staffAgenda.js'])
</head>
<body class="bg-gradient-to-br from-gray-50 via-white to-gray-100 font-inter min-h-screen">
    ...
    <footer class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <!-- Bottom Section -->
            <div class="border-t border-gray-700 mt-1 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <div class="text-gray-400 text-sm">
                        Made with ❤️ by <a href="https://github.com/wyanns-404" class="text-gray-300 hover:text-accent transition-colors duration-300 text-sm" target="_blank">Anak Magang</a> | 2025
                    </div>
                    <div class="flex items-center space-x-6">
                        <a href="https://github.com/wyanns-404/kalender-kegiatan-bbpom-lampung" class="text-gray-400 hover:text-primary transition-colors duration-300" target="_blank">
